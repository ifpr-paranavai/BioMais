    ...
    this.questoesToquePares = [
      {
        ...
        imagem: "img26m1sc",
        legendaImagem:
          "Imagem: Adaptada de Brgfx, via Freepik.com. <a href='http://commons.wikimedia.org/wiki/File:Respiratory_system_complete_en.svg'>Disponível aqui</a>.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
      ...
      },
      {
        ...
        feedBackImagem: "SEM",
        feedBackLegendaImagem: "Imagem: Adaptada de Zoofari, (Creative Commons BY-SA 3.0), via Wikimedia Commons. <a href='http://commons.wikimedia.org/wiki/File:Respiratory_system_complete_en.svg'>Disponível aqui</a>.",
        feedBackTexto:        
