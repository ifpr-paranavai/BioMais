  ...
  constructor() {
    this.questoesToquePares = [
      ...
      },
      {
        ...
        imagem: "img3m1mus",
        legendaImagem:
          "Imagem: Adaptada de OpenStax, Tomáš Kebert e umimeto.org, Creative Commons BY-SA 4.0, via Wikimedia Commons. <a href='http://commons.wikimedia.org/wiki/File:Respiratory_system_complete_en.svg'>Disponível aqui</a>.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
