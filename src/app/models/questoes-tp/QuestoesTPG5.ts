    ...
    this.questoesToquePares = [
      {
        ...
        imagem: "img1m1repro",
        legendaImagem:
          "Imagem: Adaptada de Wumingbai, <a href='https://creativecommons.org/publicdomain/zero/1.0/deed.en'>Domínio Público</a>, via Wikimedia Commons. <a href='https://commons.wikimedia.org/wiki/File:Structure_of_the_human_penis.svg'>Disponível aqui</a>.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
      ...
      },
      {
        ...
        imagem: "img2m1repro",
        legendaImagem:
          "Imagem: Adaptada de Fyrstinnen, <a href='https://creativecommons.org/licenses/by-sa/4.0/deed.en'>Creative Commons BY-SA 4.0</a>, via Wikimedia Commons. <a href='https://commons.wikimedia.org/wiki/File:Vagina_vulva_drawing_with_pointers_and_numbers.jpg'>Disponível aqui</a>.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
      ...
      },
      {
        ...
        imagem: "img3m1repro",
        legendaImagem:
          "Imagem: Adaptada de Jmarchn, <a href='https://creativecommons.org/licenses/by-sa/3.0/deed.en'>Creative Commons BY-SA 3.0</a>, via Wikimedia Commons. <a href='https://commons.wikimedia.org/wiki/File:Scheme_female_reproductive_non-labels.svg'>Disponível aqui</a>.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
