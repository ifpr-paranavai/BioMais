    ...
    this.questoesToquePares = [
      {
        ...
        imagem: "img1m1repro",
        legendaImagem:
          "Imagem: Adaptada de Wumingbai, Domínio Público, via Wikimedia Commons. Disponível aqui.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
      ...
      },
      {
        ...
        imagem: "img2m1repro",
        legendaImagem:
          "Imagem: Adaptada de Fyrstinnen, Creative Commons BY-SA 4.0, via Wikimedia Commons. Disponível aqui.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
      ...
      },
      {
        ...
        imagem: "img3m1repro",
        legendaImagem:
          "Imagem: Adaptada de Jmarchn, Creative Commons BY-SA 3.0, via Wikimedia Commons. Disponível aqui.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
