  ...
  constructor() {
    this.questoesToquePares = [
      ...
      },
      {
        ...
        imagem: "img3m1sd",
        legendaImagem:
          "Imagem: Adaptada de LadyofHats, Domínio público, via Wikimedia Commons.  <a href='http://commons.wikimedia.org/wiki/File:Respiratory_system_complete_en.svg'>Disponível aqui</a>.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
      ...
      },
      {
        ...
        imagem: "img9m1sd",
        legendaImagem:
          "Imagem: Adaptada de Patrick J. Lynch, ilustrador médico, Creative Commons BY 2.5, via Wikimedia Commons. <a href='http://commons.wikimedia.org/wiki/File:Respiratory_system_complete_en.svg'>Disponível aqui</a>.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
      ...
      },
      {
        ...
        imagem: "img17m1sd",
        legendaImagem:
          "Imagem: Adaptada de LukesAnatomy, Creative Commons BY-SA 3.0, via Wikimedia Commons. <a href='http://commons.wikimedia.org/wiki/File:Respiratory_system_complete_en.svg'>Disponível aqui</a>.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
      ...
      },
      {
        ...
        imagem: "img18m1sd",
        legendaImagem:
          "Imagem: Adaptada de Macrovector, via Freepik.com. <a href='http://commons.wikimedia.org/wiki/File:Respiratory_system_complete_en.svg'>Disponível aqui</a> e aqui.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
