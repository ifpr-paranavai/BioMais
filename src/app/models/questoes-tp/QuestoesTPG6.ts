  ...
  constructor() {
    this.questoesToquePares = [
      ...
      },
      {
        ...
        legendaImagem:
          "Imagens: Adaptadas de OpenStax College, <a href='https://creativecommons.org/licenses/by-sa/3.0/deed.en'>Creative Commons BY-SA 3.0</a>, via Wikimedia Commons. <a href='https://commons.wikimedia.org/wiki/File:909_Types_of_Synovial_Joints_esp.jpg'>Disponíveis aqui</a>.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
        ...
        feedBackLegendaImagem:
        "Imagem: Adaptadas de OpenStax College, <a href='https://creativecommons.org/licenses/by-sa/3.0/deed.en'>Creative Commons BY-SA 3.0</a>, via Wikimedia Commons. <a href='https://commons.wikimedia.org/wiki/File:909_Types_of_Synovial_Joints_esp.jpg'>Disponíveis aqui</a>.",
        feedBackTexto:
