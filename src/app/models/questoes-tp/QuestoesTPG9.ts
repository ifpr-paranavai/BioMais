  ...
  constructor() {
    this.questoesToquePares = [
      ...
      },
      {
        ...
        legendaImagem:
          "Imagens: Adaptadas de Holly Fischer, <a href='https://creativecommons.org/licenses/by/3.0/deed.en'>Creative Commons BY-SA 3.0</a>, via Wikimedia Commons. <a href='https://commons.wikimedia.org/wiki/File:Three_Basic_Types_of_Neuronal_Arrangements.png'>Disponíveis aqui</a>.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
        ...
        feedBackLegendaImagem:
          "Imagem: Adaptadas de Holly Fischer, <a href='https://creativecommons.org/licenses/by/3.0/deed.en'>Creative Commons BY-SA 3.0</a>, via Wikimedia Commons. <a href='https://commons.wikimedia.org/wiki/File:Three_Basic_Types_of_Neuronal_Arrangements.png'>Disponível aqui</a>.",
        feedBackTexto:
