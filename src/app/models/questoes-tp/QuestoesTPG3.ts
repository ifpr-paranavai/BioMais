    ...
    this.questoesToquePares = [
      {
        ...
        imagem: "img1m1res",
        legendaImagem:
          "Imagem: Adaptada de LadyoHats, Domínio Público, via Wikimedia Commons. <a href='http://commons.wikimedia.org/wiki/File:Respiratory_system_complete_en.svg'>Disponível aqui</a>.",
        pares: [
          {
            id: 1,
            corBorda: "#F0E68C",
