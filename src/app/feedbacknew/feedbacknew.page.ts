...
/*     alert(img);
    if (img.includes("gif")) {
      this.image = "assets/imagens/questoes/" + img + ".gif";
    } else if (!img.includes("SEM") && img != "") {
      this.image = "assets/imagens/questoes/" + img + ".png";
    } */

    /* this.image = "assets/imagens/questoes/feedback1m3uri.png"; */
